...
**Myanmar's military held its election inside an information environment it had spent four years making permanent. No emergency blackout was needed — the digital silence was already structural.**
...
A note on what our data cannot say: our BGP routing monitor began operating in April 2026, after the election concluded. We therefore cannot confirm or deny BGP-layer prefix withdrawals — the most definitive evidence of deliberate network shutdown — during the election period from our own data. Live BGP monitoring across 130+ Myanmar autonomous systems is now active on our [BGP Observatory](/observatory/bgp/). For routing-layer analysis of the election window, see [IODA](https://ioda.inetintel.cc.gatech.edu) and [NetBlocks](https://netblocks.org).
...
1. **No election-day spike confirms ambient censorship.** The OONI anomaly rate in December 2025 (18.6%) was *lower* than November (23.2%). When no emergency action is needed on polling day, it is because the censorship infrastructure is already comprehensive enough to be permanent.

2. **Facebook, Myanmar's primary political platform, was effectively eliminated.** An 89% OONI anomaly rate means the platform that functions as the country's de facto public square was inaccessible to the overwhelming majority of users during the campaign and voting period.

3. **Independent media was blocked at the network layer, not just filtered.** Irrawaddy, Myanmar Now, Mizzima, and DVB each returned 66–78% anomaly rates — not social pressure or self-censorship, but technical blocking enforced by ISPs operating under military control.

4. **The escape route was also closed.** VPN and circumvention tools were blocked at 69–87% anomaly rates under the new Cybersecurity Law, meaning users who knew how to route around censorship found that route legally and technically obstructed.

5. **The February 2026 Cloudflare Radar spike signals a qualitative shift.** A sustained 93–100% traffic index over multiple weeks is not explained by user behavior; it is consistent with the activation of centralized routing infrastructure modelled on China's Great Firewall — a structural change from targeted blocking to network-layer control.

6. **131+ blacked-out townships produced no data and no ballots.** This means aggregate censorship statistics *underrepresent* the actual information environment: the populations most severely affected are precisely those invisible to OONI measurement.
...
## Download the Election Censorship Snapshot

A one-page research brief summarising the key findings and charts from this article, suitable for sharing with editors, NGOs, and institutional partners.

[**Download: Election Censorship Snapshot (PDF)**](/assets/election-censorship-snapshot-2025-26.pdf) — 128 KB · April 2026
...
| [BGP Outages](/data/bgp_events.csv) | CSV | BGP prefix withdrawal events, April 2026 – present |
| [Unified Events](/data/unified_events.json) | JSON | All sources merged and cross-validated |

Please cite as: *Internet in Myanmar Observatory, internetinmyanmar.com*. OONI data published under CC BY 4.0; Cloudflare Radar under CC BY-NC 4.0.
